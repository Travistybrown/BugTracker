...
{
    // Inheritience of the interface
    public class BTRoleService : IBTRolesService
    {        


        // Declaring a property and its type
        private readonly UserManager<BTUser> _userManager;
        private readonly ApplicationDbContext _context;

        // using dependecy injection to be able to use it
        public BTRoleService( UserManager<BTUser> userManager,
        ...
        public async Task<List<BTUser>> GetUsersInRoleAsync(string roleName, int companyId)
        {
            try
            {
                ...
                result = users.Where(x => x.CompanyId == companyId).ToList();
